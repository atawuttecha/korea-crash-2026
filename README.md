...
> **หมายเหตุการอ่านกราฟ:** ใน Figure 1–3 **วงกลมสีม่วง** ใช้ชี้จุดที่ต้องสังเกตเป็นพิเศษ (เช่น จุดพีคของดัชนี ค่าล่าสุดของ GDP และจุดที่ราคาน้ำมันกระโดด) ส่วนแถบสีในกราฟอื่นๆ ใช้คลุมช่วงวิกฤตตามเดิม
...
**สิ่งที่กราฟแสดง:** สามแผงเรียงบนลงล่าง — ① ราคาเบรนท์สกุลวอนแบบ YoY ② CPI YoY พร้อมเส้นเป้าหมาย 2% และเส้นเฝ้าระวัง 3% ③ กราฟเส้นแสดงว่าราคาน้ำมันเมื่อ k เดือนก่อนสัมพันธ์กับเงินเฟ้อเดือนปัจจุบันมากแค่ไหน (2000–2026) ยิ่งจุดสูงยิ่งสัมพันธ์กันมาก · วงกลมสีม่วงชี้จุดที่ต้องสังเกตในแต่ละแผง

**ข้อสรุปสำคัญ:** ราคาเบรนท์กระโดดจาก 71.12 เป็น 109.72 ดอลลาร์ (+54% ภายในเดือนเดียว, ก.พ.→มี.ค. 2026) เงินเฟ้อทะลุ 3% ในเดือน พ.ค.–มิ.ย. ตรงกับช่วงจุดพีคของดัชนี ความสัมพันธ์สูงที่สุดในช่วง lag 1–7 เดือน (r ≈ 0.50–0.52 เกือบเท่ากันทั้งช่วง) และจางลงหลังเดือนที่ 8 จึงสรุปได้เพียงว่า **ส่งผ่านภายในไม่กี่เดือน ไม่ใช่เดือนใดเดือนหนึ่งที่แน่นอน** อัตราดอกเบี้ยไม่เปลี่ยนแปลงตลอดช่วง → เงินเฟ้อจากฝั่งต้นทุนที่นโยบายการเงินไม่ได้ตอบสนอง
...
<a id="fig10"></a>
### Figure 10 · ความเสียหายกระจุกอยู่ที่ใครและความผันผวนฉีกตัวหรือไม่
